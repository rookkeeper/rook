...
- Session-to-environment membership persists in `session_environments`; on first use after restart, known repository-backed memberships are rehydrated before workspace/runtime recovery, while unavailable environments remain visible as entered entries and retain their deterministic personal authoring projection
