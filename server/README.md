...
- Session-to-environment membership persists in `session_environments`; on first use after restart, known repository-backed memberships are rehydrated before workspace/runtime recovery, while unavailable environments are skipped without deleting membership
