...
- the environment repository databases: environments, reusable capabilities, and bundle memberships for the canonical, personal, and web repositories; the web database also holds per-host scout state
