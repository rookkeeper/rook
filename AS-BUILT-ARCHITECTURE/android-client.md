...
### Chat flow
1. session selection partitions REST summaries into server-owned ordered Pinned and recency-sorted Recent sections; Pin/Unpin is exposed from the row overflow menu
