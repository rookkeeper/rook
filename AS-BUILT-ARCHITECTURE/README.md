...
The server is the stable broker. Clients are thin native surfaces over the same REST + ACP contract. Environment-repository storage, revisioning, materialization, and authoring details are documented in [server.md](./server.md) and [database.md](./database.md), with the migration recap in [../CHANGES/2026-08-01-environment_repo_to_db/recap.md](../CHANGES/2026-08-01-environment_repo_to_db/recap.md).
