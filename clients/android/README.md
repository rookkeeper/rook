...
The session-selection screen shows durable Pinned and recency-sorted Recent sections; Pin/Unpin is available from each row's overflow menu. The repo-level launcher target is currently being split/reworked. For the
