...
data class AgentSessionSummary(val raw: JsonObject) {
    val id: String get() = raw["sessionId"]?.stringValue ?: ""
    val agent: String get() = raw["_meta"]?.jsonObject?.get("runtimeId")?.stringValue ?: ""
    val name: String get() = raw["title"]?.stringValue ?: "default"
    ...
    val createdAt: Instant?
        get() = parseInstant(raw["_meta"]?.jsonObject?.get("startedAt")?.stringValue)
