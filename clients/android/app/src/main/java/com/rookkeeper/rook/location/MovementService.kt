...
package com.rookkeeper.rook.location
...
import com.rookkeeper.rook.MainActivity
import com.rookkeeper.rook.model.IdentifyAvailableRequest
import com.rookkeeper.rook.model.Place
import com.rookkeeper.rook.movement.AccelStats
import com.rookkeeper.rook.movement.MovementClassifier
import com.rookkeeper.rook.movement.MovementType
import com.rookkeeper.rook.movement.VoteDebouncer
import com.rookkeeper.rook.net.AuthTokenStore
...
class MovementService : Service(), SensorEventListener {
    ...
    private fun buildNotification(): Notification {
        ...
        return builder
            ...
            .setSmallIcon(com.rookkeeper.rook.R.drawable.ic_notification)
            .setOngoing(true)
