...
final class EnvironmentProviderTests: XCTestCase {
    ...
    func testFinderObservationParsesCurrentAndOpenDirectories() {
    ...
    func testFinderCandidatesEmitDirectoryEnvironments() {
    ...
    @MainActor
    func testFinderProviderTracksCurrentDirectoryEnvironmentId() {
